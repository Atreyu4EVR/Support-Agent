  ...
  return (
    <>
      <div className="relative" ref={dropdownRef}>
        ...
        >
          <MoreVertical className="w-4 h-4 md:w-5 md:h-5 text-gray-900 dark:text-white" />
        </button>

        {/* Dropdown Menu */}
        {isOpen && (
          <div className="absolute right-0 top-full mt-1 w-44 md:w-48 bg-white dark:bg-zinc-800 border border-gray-200 dark:border-zinc-700 rounded-lg shadow-lg z-50">
            <div className="py-1">
              <button
      ...
      {showHistoryModal && sessionHistory && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2 md:p-4">
          <div className="bg-white dark:bg-zinc-800 rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] md:max-h-[80vh] overflow-hidden">
