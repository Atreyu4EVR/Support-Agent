...
interface FeaturesAvailabilityProps {
  isOpen: boolean;
  onClose: () => void;
}

export const FeaturesAvailability: React.FC<FeaturesAvailabilityProps> = ({
  isOpen,
  onClose,
}) => {
            ...
            <div className="mt-3 text-center sm:ml-4 sm:mr-6 sm:mt-0 sm:text-left w-full">
              ...
              <div className="mt-4">
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                  The BYUI Support Agent is{" "}
                  <span className="font-semibold text-primary-600 dark:text-primary-400">
                    hosted securely by Microsoft Azure
                  </span>
                  , and is available 24/7, 365 days a year.
                </p>
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                  The entire technical infrastructure was built{" "}
                  <span className="font-semibold text-primary-600 dark:text-primary-400">
                    cloud-first
                  </span>
                  , and is designed to be highly available and scalable.
                </p>
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                  This allows the application to handle multiple concurrent
                  users during peak periods, such as registration and financial
                  aid deadlines.
                </p>
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                  This is a significant improvement over traditional support
                  systems that depend on human staff and are only available
